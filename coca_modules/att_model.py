...
import coca_modules.utils as utils
from coca_modules.caption_model import CaptionModel
...
class AttModel(CaptionModel):
    def __init__(self, args, tokenizer):
        ...
        cocamodel, _, _ = open_clip.create_model_and_transforms(
            ...
            pretrained="/home/Huangwb/.cache/huggingface/hub/models--laion--CoCa-ViT-B-32-laion2B-s13B-b90k/open_clip_pytorch_model.bin"
        )
    ...
    def _sample(self, images, att_masks=None):
