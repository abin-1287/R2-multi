from multiclass_models.r2gen import R2GenModel
from multiclass_modules.loss import compute_loss
from multiclass_modules.trainer import Trainer
from multiclass_modules.optimizers import build_optimizer, build_lr_scheduler
from multiclass_modules.metrics import compute_scores
from multiclass_modules.dataloaders import R2DataLoader
from multiclass_modules.tokenizers import Tokenizer
import numpy as np
import errno
import argparse
import torch
...
def parse_agrs():
    ...
    parser.add_argument('--save_dir', type=str, default='R2Gen-multiclass/debug/result/',
                        help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default='R2Gen-multiclass/debug/record/',
    ...
    parser.add_argument('--lr_ve', type=float, default=1e-4,
